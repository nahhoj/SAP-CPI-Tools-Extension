    ...
    return{        
        ...
        addStateObjectsContentPackage:async (id)=>{
            ...
            for(const artifact of artifactTable.getModel().oData.oArtifacts.results){
                ...
                for(const name of iflowsDeployed){
                    if (name.textContent == artifact.name){
                        artifact[`${constants.prefixId}status`]="Deployed";
                        artifact[`${constants.prefixId}statusColor`]="Success";
                        break;
                    }                    
                }
